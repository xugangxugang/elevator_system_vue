<template>
  <div>
    <el-card>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="searchQuery" placeholder="搜索制造单位" @input="search" clearable />
        </el-col>
        <el-col :span="6">
          <el-button @click="exportData">导出数据</el-button>
        </el-col>
        <el-col :span="6">
          <el-button type="primary" @click="addItem">新增制造单位</el-button>
        </el-col>
      </el-row>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle">
      <el-form :model="formData" label-width="120px">
        <el-form-item label="制造单位">
          <el-input v-model="formData.制造单位" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const resource = ref('elevatorManufacturers');
const resourceName = ref('电梯制造单位表');
