<template>
  <div>
    <el-card>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="searchQuery" placeholder="搜索额定速度" @input="search" clearable />
        </el-col>
        <el-col :span="6">
          <el-button @click="exportData">导出数据</el-button>
        </el-col>
        <el-col :span="6">
          <el-button type="primary" @click="addItem">新增额定速度</el-button>
        </el-col>
      </el-row>
...
const resource = ref('ratedSpeeds');
const resourceName = ref('额定速度表');
