<template>
  <div>
    <el-card>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="searchQuery" placeholder="搜索楼层站门" @input="search" clearable />
        </el-col>
        <el-col :span="6">
          <el-button @click="exportData">导出数据</el-button>
        </el-col>
        <el-col :span="6">
          <el-button type="primary" @click="addItem">新增楼层站门</el-button>
        </el-col>
      </el-row>
...
const resource = ref('floorStations');
const resourceName = ref('楼层站门表');

const columns = ref<Column[]>([
  { prop: 'ID', label: 'ID' },
  { prop: '楼层站门', label: '楼层站门' },
