<template>
  <div>
    <el-card>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="searchQuery" placeholder="搜索额定载荷" @input="search" clearable />
        </el-col>
        <el-col :span="6">
          <el-button @click="exportData">导出数据</el-button>
        </el-col>
        <el-col :span="6">
          <el-button type="primary" @click="addItem">新增额定载荷</el-button>
        </el-col>
      </el-row>
...
const resource = ref('ratedLoads');
const resourceName = ref('额定载荷表');
const columns = ref<Column[]>([
  { prop: 'ID', label: 'ID' },
  { prop: '额定载荷', label: '额定载荷' },
