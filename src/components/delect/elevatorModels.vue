<template>
  <div>
    <el-card>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="searchQuery" placeholder="搜索电梯型号" @input="search" clearable />
        </el-col>
        <el-col :span="6">
          <el-button @click="exportData">导出数据</el-button>
        </el-col>
        <el-col :span="6">
          <el-button type="primary" @click="addItem">新增电梯型号</el-button>
        </el-col>
      </el-row>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle">
      <el-form :model="formData" label-width="120px">
        <el-form-item label="电梯型号">
          <el-input v-model="formData.电梯型号" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const resource = ref('elevatorModels');
const resourceName = ref('电梯型号表');

const columns = ref<Column[]>([
  { prop: 'ID', label: 'ID' },
  { prop: '电梯型号', label: '电梯型号' },
