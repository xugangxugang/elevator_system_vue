<template>
  <div>
    <el-card>
      ...
      <el-row>
        <el-col :span="12">
          <el-input v-model="searchQuery" placeholder="搜索文件类型名称" @input="search" clearable />
        </el-col>
        <el-col :span="6">
          <el-button @click="exportData">导出数据</el-button>
        </el-col>
        <el-col :span="6">
          <el-button type="primary" @click="addItem">新增文件类型</el-button>
        </el-col>
      </el-row>
...
const resource = ref('fileTypes');
const resourceName = ref('文件类型表');

const columns = ref<Column[]>([
  { prop: 'ID', label: 'ID' },
  { prop: '文件类型名称', label: '文件类型名称' },
